...
export const experience: Experience[] = [
  ...
  {
    company: "Etherial Holdings Inc.",
    role: "IT Support / Systems Administrator & AI Automation Specialist",
    location: "Remote — Lagos (HQ: Toronto, Canada)",
    start: "2026-06",
    end: "Present",
    kind: "engineering",
    highlights: [
      "Built an automated client onboarding workflow integrating Copper CRM, Trello, DocuSign, and Zapier — CRM pipeline stages mapped to a 7-step Trello board with automated stage advancement on document signing.",
      "Resolved critical email deliverability issues by configuring SPF, DKIM, and DMARC authentication across Google Workspace; administer email routing, shared drives, and user permissions.",
      "Manage DNS, hosting, and domain infrastructure across five company domains on Hostinger — including diagnosing and resolving a 403 outage caused by a premature DNS cutover during a domain migration.",
      "Deployed and maintain a Google Apps Script backend for form processing with automated logging, failure alerts, and configurable security.",
    ],
    stack: [
      "Google Workspace",
      "Copper CRM",
